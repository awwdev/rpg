...
struct Widget_List
{
    ...
    void Update(gpu::RenderData& renderData)
    {
        ...
        const bool isMouseOnList = use::IsPointInsideRect(wnd::glo::mouse_wx, wnd::glo::mouse_wy, back);
        ...
        if (isMouseOnList && wnd::glo::mouse_scroll_delta != 0){
            ...
            use::Clamp(scroll, 0, items.count - 1);
        }
        ...
        for(idx_t idx = scroll; idx < items.count; ++idx)
        {
            ...
            const bool isMouseOnItem = isMouseOnList && use::IsPointInsideRect(wnd::glo::mouse_wx, wnd::glo::mouse_wy, itemRect);
